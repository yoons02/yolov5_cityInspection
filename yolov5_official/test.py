...
if __name__ == '__main__':
    ...
    #parser.add_argument('--data', type=str, default='data/traffic.yaml', help='*.data path')
#parser.add_argument('--data', type=str, default='data/traffic.yaml', help='data.yaml path')
    parser.add_argument('--batch-size', type=int, default=32, help='size of each image batch')#32
