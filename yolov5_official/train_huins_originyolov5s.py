...
def train(hyp, opt, device, tb_writer=None, wandb=None):
    ...
    hyp['cls'] *= nc / 6.  # scale coco-tuned hyp['cls'] to current dataset
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='models/yolov5s_huins.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='data/huins.yaml', help='data.yaml path')
