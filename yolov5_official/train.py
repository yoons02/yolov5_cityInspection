...
def train(hyp, opt, device, tb_writer=None, wandb=None):
    ...
    hyp['cls'] *= nc / 5.  # scale coco-tuned hyp['cls'] to current dataset
...
if __name__ == '__main__':
    ...
    #parser.add_argument('--weights', type=str, default='runs/train/exp72/weights/best.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='models/yolov5x_huins.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='data/coco128.yaml', help='data.yaml path')
    parser.add_argument('--hyp', type=str, default='data/hyp.scratch.yaml', help='hyperparameters path')
    parser.add_argument('--epochs', type=int, default=60)
    parser.add_argument('--batch-size', type=int, default=6, help='total batch size for all GPUs') #16
    ...
    parser.add_argument('--workers', type=int, default=0, help='maximum number of dataloader workers')#8
